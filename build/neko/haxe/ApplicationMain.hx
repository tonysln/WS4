...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("WS4", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("WS4", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		#elseif air
		app.window.title = "WS4";
		#else
		app.window.context.attributes.background = 2625671;
